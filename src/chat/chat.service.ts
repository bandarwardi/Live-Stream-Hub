...
export class ChatService {
  ...
  async saveMessage(broadcastId: string, userId: string, text: string, type: string = 'message') {
    ...
    return this.messageModel.findById(message._id).populate('sender', 'username displayName avatarUrl').exec();
  }
